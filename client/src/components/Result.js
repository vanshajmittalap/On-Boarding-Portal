...
const Result = () => {
  ...
  <div className='container'>
            ...
            <div style={{display:"flex", justifyContent:"center", alignItems:"center"}}><a href="https://www.iiitp.ac.in/" target='_blank' rel='noreferrer' class="btn btn-danger " role="button" >IIIT Pune</a>
            {localStorage.getItem('token') && (<Link className="btn btn-danger mx-1" to="/profile" role="button" style={{}}>YOUR PROFILE</Link>)}
            </div>
        </div>
  </>
};
